...
namespace BaseConverterXamarinForms.ViewModels
{
    public class ConverterViewModel : INotifyPropertyChanged
    {
        ...
        public ICommand TBGotFocusCommand => new Command((sender) => ExecuteGotFocus((string)sender));
        public ICommand TBLostFocusCommand => new Command((sender) => ExecuteLostFocus((string)sender));
