...
namespace BaseConverter.ViewModels
{
    public class ConverterViewModel : ReactiveObject
    {
        ...
        public ConverterViewModel()
        {
            ...
            TBGotFocusCommand = ReactiveCommand.Create<string, Unit>(sender => ExecuteGotFocus(sender));
            TBLostFocusCommand = ReactiveCommand.Create<string, Unit>(sender => ExecuteLostFocus(sender));
        }

        public ReactiveCommand<string, Unit> TBGotFocusCommand { get; }
        public ReactiveCommand<string, Unit> TBLostFocusCommand { get; }

        public static Unit ExecuteGotFocus(string sender)
        {
        ...
        private static Unit ExecuteLostFocus(string sender)
        {
        ...
        private static bool _hasTBDecimalFocus = false;
        private static bool _hasTBBinaryFocus = false;
        private static bool _hasTBOctalFocus = false;
        private static bool _hasTBHexadecimalFocus = false;
